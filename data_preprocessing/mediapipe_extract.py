...
if __name__ == "__main__":
    gen_keypoints_for_video("C:/Video_sample/I_am_good_thankyou.mov", "C:\ICSL\holistic_poses\sample_continuous.pkl")
    
    #gen_keypoints_for_folder("C:\Video_sample", save_path, file_patterns)
    n_cores = multiprocessing.cpu_count()

    DIR = "ICSL/train/"
    SAVE_DIR = "ICSL/holistic_poses/"
